...
import { PrivacyHero } from "./_skyline/legal/PrivacyHero";
import { PrivacyContent } from "./_skyline/legal/PrivacyContent";

/** Skyline Holding "Privacy Policy" page, routed at /privacy. */
